			...
			<div className="max-w-md mx-auto">
				...
				<div className="divide-y divide-gray-200">
					<div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
						...
						<div className="relative">
							<button className="bg-blue-500 text-white rounded-md px-2 py-1 ml-28 mt-4">Submit</button>
						</div>
						<p>Don't have an account?
							<Link to={"/register"} className='ml-2 bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-transparent'>
							Register Now
							</Link> 
							</p>
					</div>
